package com.qwertcardo.eventoapp.controllers;
...
import com.qwertcardo.eventoapp.repository.ConvidadoRepository;
import com.qwertcardo.eventoapp.repository.EventoRepository;
...
public class EventoController {
	...
	public String deletarConvidado(String rg) {
		...
		cr.delete(convidado);
		String codigo = String.valueOf(convidado.getEvento().getCodigo());
		return "redirect:/" + codigo;
	}
}
